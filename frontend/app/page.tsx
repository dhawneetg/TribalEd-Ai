        ...
        <section className="pt-16 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#eeece7] text-xs font-mono text-[#75758a] mb-6">
              ...
              AI-POWERED SCHOLARSHIP SCRUTINY &amp; GOVERNANCE (SIH ID 26239)
            </div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              ...
              >
                ...
                Track Application / Fix Deficiency &rarr;
              </Link>
            </div>
          </div>
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-[22px] bg-[#eeece7]/40 border border-[#d9d9dd] flex flex-col justify-between">
              <div>
                <span className="text-xs font-mono text-[#1863dc] uppercase">SCHOLAR PORTAL</span>
                <h3 className="text-lg font-medium text-[#17171c] mt-1">Direct Intake &amp; e-KYC</h3>
                <p className="text-xs text-[#616161] mt-2">
                  Paperless application wizard connecting directly with DigiLocker with instant rule evaluation.
                </p>
              </div>
            ...
            <div className="p-6 rounded-[22px] bg-[#eeece7]/40 border border-[#d9d9dd] flex flex-col justify-between">
              <div>
                <span className="text-xs font-mono text-[#ff7759] uppercase">MICRO-DEFICIENCY</span>
                <h3 className="text-lg font-medium text-[#17171c] mt-1">7-Day Targeted Remediation</h3>
                <p className="text-xs text-[#616161] mt-2">
                  Got an SMS/WhatsApp flag? Re-upload only the specific blurry or missing document without refilling forms.
                </p>
              </div>
              <div className="mt-6 pt-4 border-t border-[#d9d9dd]">
                <Link href="/track" className="btn-pill-outline text-xs py-2 px-4 inline-flex items-center gap-1">
                  Resolve Deficiency &rarr;
                </Link>
              </div>
            </div>
            ...
            <div className="p-6 rounded-[22px] bg-[#eeece7]/40 border border-[#d9d9dd] flex flex-col justify-between">
              <div>
                <span className="text-xs font-mono text-[#003c33] uppercase">GOVERNANCE &amp; DBT</span>
                <h3 className="text-lg font-medium text-[#17171c] mt-1">MoTA Executive Analytics</h3>
                <p className="text-xs text-[#616161] mt-2">
                  Scheduled Area heatmaps, verification turnaround bottleneck analytics, and PFMS DBT disbursement batch generator.
                </p>
              </div>
              <div className="mt-6 pt-4 border-t border-[#d9d9dd]">
                <Link href="/officer/analytics" className="btn-pill-outline text-xs py-2 px-4 inline-flex items-center gap-1">
                  Open MoTA Analytics &rarr;
                </Link>
              </div>
            </div>
          </div>
